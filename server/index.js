...
const studentAttendanceRoute = require('./src/routes/attendance/student/studentAttendance.route');
const adminAttendanceRoute = require('./src/routes/attendance/admin/adminAttendance.route');
