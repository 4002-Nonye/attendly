...
function StudentAttendanceCard({ course }) {
        ...
        <div className="mb-4">
          <div className="flex items-start justify-between gap-2 mb-3">
            <div className="flex justify-between items-center w-full gap-1">
              ...
              <span className={`text-xs font-medium text-center  px-2.5 whitespace-nowrap  py-1 rounded-md border ${badgeColor}`}>
                {course.courseCode}
              </span>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
            <div
              className={`h-full rounded-full ${getProgressBarColor(course.attendancePercentage)} transition-all duration-500 ease-out`}
