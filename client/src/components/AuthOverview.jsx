...
function AuthOverview() {
  return (
    <div className='hidden w-2/4 bg-blue-950 text-white h-dvh lg:flex flex-col  p-5 lg:p-14 '>
      ...
      <div className=' m-auto'>
        ...
        <p className='w-[100%] lg:w-[80%] leading-7'>
          ...
          generate reports at the end. Attendance has never been this effortless
          and convenient.
        </p>
      </div>
    </div>
